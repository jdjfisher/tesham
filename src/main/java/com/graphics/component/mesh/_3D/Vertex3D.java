...
public class Vertex3D {
    ...
    public Vertex3D(Vector3f position, Vector3f normal, Vector2f textureCoord){
        this(position, normal, textureCoord, null, null);
    }

    public Vertex3D(Vector3f position, Vector2f textureCoord, Vector3f tangent, Vector3f bitangent){
        this(position, null, textureCoord, tangent, bitangent);
    }

    public Vertex3D(Vector3f position, Vector3f normal, Vector2f textureCoord, Vector3f tangent, Vector3f bitangent){
